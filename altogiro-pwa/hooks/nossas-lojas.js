{
  "--alterarMapa": component=>{
    ...
    var op1 = document.getElementById("ag-mapa-opcao-1");
    var op2 = document.getElementById("ag-mapa-opcao-2");
    var op3 = document.getElementById("ag-mapa-opcao-3");
    ...
    var input = document.getElementById('ag-busca-cep-mapa');
