<template>
    <div class="modal-C" id="agendaVisita">
		<div class="modal-content">
			<div class="modal-topo">
				<b-row class="linhaHEADER" align-h="end">
					<b-col v-if="!respostaAgendaAgora" class="titleHeader" cols="10"> <!-- Por enquanto, não agendei -->
						<h3>Para agendar sua visita, escolha um dia e horário</h3>
					</b-col>
					<b-col v-else class="titleHeader" cols="10"> <!-- Beleza, agendei -->
						<h3>Agendado com sucesso!</h3>
					</b-col>
					<b-col cols="2">
						<span v-on:click="showModalAgendaVisita('close')" class="closeModal">X</span>
					</b-col>
				</b-row>
			</div>
			...
			<div class="modal-corpo">
				<div v-if="logged == false"> <!-- Eu não estou logado ? -->
					...
					<login-panel v-if="logged == false" v-bind:loading="this.loading" v-on:loginEfetuado="atualizaLogged"/>
				</div>

				<div v-else> <!-- Eu estou logado! -->
					<div v-if="!respostaAgendaAgora"> <!-- Por enquanto, não agendei -->
						<vue-cal 
						style="height: 250px" 
						default-view="week" 
						locale="pt-br" 
					...
					<div v-else>
						<b-row class="text-center">
							<p class="alert alert-success" style="width: 100%">
								Aguarde um corretor confirmar seu agendamento.<br/>Você será avisado via e-mail quando o corretor aceitar a visita.
							</p>
						</b-row>
					</div>
				</div>
