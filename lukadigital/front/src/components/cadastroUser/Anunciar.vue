<template>
  	<div class="col-md-12 col-xs-12 anunciarImovel">
		...
		<div class="row">
			<div class="col-md-6 col-xs-12 form-linha">
				...
				<input type="file" v-bind:class="{'erroInput': (!img1 && triggered)}" name="enviaFotoPerfil" ref="myFiles" @change="uploadFoto('enviaFotoPerfil'); update1()" placeholder="Escolha uma foto" accept="image/*">
			</div>
			<div class="col-md-6 col-xs-12 form-linha">
		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<select @change="alteraTipo()" name="tipoPessoaAlugar" v-model="globalForm.person_type" class="padraoSelect" >
		...
		<div v-if="globalForm.person_type == 'F'" class="row">
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<input v-on:keyup="mascaraRg()" v-model="globalForm.documents.rg" type="text" class="input-text" name="rgAlugar" v-bind:class="{'erroInput': erro.documents.rg}" id="rgAlugar" maxlength="9" value>
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<i class="sl sl-icon-doc"></i>
				<input v-on:keyup="mascaraCpf()" v-on:blur="verificacoes('cpf')" v-bind:class="{'erroInput': erro.documents.cpf}" v-model="globalForm.documents.cpf" type="text" class="input-text" name="cpfAlugar" id="cpfAlugar" maxlength="13" value >
		...
		<div v-if="globalForm.person_type == 'F'" class="row">
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<select v-bind:class="{'erroInput': erro.pf_data.nacionalidadeId}" v-model="globalForm.pf_data.nacionalidadeId" name="nacionaAlugar" class="padraoSelect">
					<option v-for="nac in nacionalidades" :value="nac.id" :selected="nac.name == 'BRASILEIRO' ? 'selected' : ''" v-bind:key="nac.id">
						{{nac.name}}
					</option>
				</select>
		...
		<div v-if="globalForm.person_type == 'F'" class="row">
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<select v-bind:class="{'erroInput': erro.pf_data.profissaoId}" v-model="globalForm.pf_data.profissaoId" name="profissaoAlugar" class="padraoSelect" >
					<option v-for="prof in profissao" :value="prof.id" v-bind:key="prof.id">
						{{prof.name}}
					</option>
				</select>
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<select v-bind:class="{'erroInput': erro.pf_data.estadoCivilId}" v-model="globalForm.pf_data.estadoCivilId" name="estadocivilAlugar" class="padraoSelect" >
					<option v-for="estC in estadoCivil" :value="estC.id" v-bind:key="estC.id">
						{{estC.name}}
					</option>
				</select>
		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-12 form-linha">
				...
				<i class="sl sl-icon-location"></i>
				<input v-bind:class="{'erroInput': erro.bairro}" v-model="globalForm.addresses.bairro" type="text" class="input-text" name="bairroAlugar" id="bairroAlugar" value>
		...
		<div class="row">
			...
			<div class="col-md-6 col-xs-12 form-linha">
				...
				<input v-on:keyup="mascaraTELEFONE('whats')" v-bind:class="{'erroInput': erro.telephones.whats}" v-model="globalForm.telephones.whats" type="text" class="input-text" name="whatsAlugar" id="whatsAlugar" maxlength="13" value>
			...
			<div class="col-md-6 col-xs-12 form-linha">
				...
				<input v-on:keyup="mascaraTELEFONE('tel')" v-model="globalForm.telephones.telefone" type="text" class="input-text" name="telAlugar" id="telAlugar" maxlength="13" value >
			</div>
		...
		<p class="pull-right">
			<a v-if="requisicao_feita == 0" v-on:click="enviaForm()" id="botaoCadastraAlugar" class="button botaoPadrao">
				Cadastrar
			</a>
		</p>
	...
	export default {
		...
		methods: {
			...
			created() {
				...
				this.globalForm.group_id.push(this.validForm.anunciar());
			} 
		}
	}
</script>