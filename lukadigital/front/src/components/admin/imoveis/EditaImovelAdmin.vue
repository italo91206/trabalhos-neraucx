      ...
      <b-row>
        ...
        <b-row>
          <div class="content-painel content-visitas">
            <h3 class="text-center titlesAdmin">Edição de imóvel</h3>
            <b-container class="ajustContainer">
              ...
              <div class="container" v-else>
                ...
                <div class="row">
                  <h3 class="col-12 mb-3">Informações internas:</h3>
                  <!-- <div class="col-md-6">
                    <label for="captador">Captador(ou responsável):</label>
                    <Multiselect v-model="op" :options="options" :multiple="false" :close-on-select="true" :clear-on-select="false" :preserve-search="true" placeholder="Pick some" label="name" track-by="name" :preselect-first="true"></Multiselect>                
                  </div>-->
                  <div class="col-md-6 col-xs-12 form-linha">
                ...
                <h3 class="titleCadastro col-12 mb-3">Imagens</h3>
                <div class="row">
                ...
                <br>
                <h3 class="titleCadastro col-12 mb-3">Localização</h3>
                <div class="row">
                  <div class="col-md-4 col-xs-12 form-linha">
...
export default {
  ...
  methods: {
    enviaForm: function() {
      ...
      this.admin("updateImovel", this.globalForm, this.$route.params.id);
    },
    ...
    recebeAjax(tipo) {
      ...
      } else if (tipo == "dadosImovel") {
        var items = [];
        var count = 0;
        /*for(var key in this.globalForm.owner_id){//ADEQUAR DADOS À MULTISELECT
                                  items[count] = {};
                                  items[count].name = this.globalForm.owner_id[key]
                                  items[count].value = this.globalForm.owner_id[key]
      ...
      switch (campo) {
        ...
        case "seguroIncendioMes":
          this.globalForm.value_data.seguroIncendioMes = this.validForm.mascaraMoeda(
            this.value_data.seguroIncendioMes
          );
          break;
         case "seguroIncendioMes":
          this.globalForm.value_data.seguroIncendioMes = this.validForm.mascaraMoeda(
  ...
  mounted() {
    ...
    this.admin("selectSingleImovel", this.$route.params.id);
