      ...
      <div class="sectioncadImovel">
        <div class="container ajustContainer">
          ...
          <!-- <div class="row espacamentoLinha d-none">
            <div class="col-md-6 col-xs-12 form-linha d-none">
          ...
          <div class="row espacamentoLinha mb-3" style="justify-content:flex-end;">
            <a
...
export default {
  ...
  methods: {
    enviaForm: function() {
      if (!this.insertOwner) {
        this.insertOwner = true;
        this.globalForm.owner_id.push(this.getIDLocalSt());
      }
    ...
    mascaraMoeda(campo) {
      switch (campo) {
        ...
        case "iptuGaragemAVista":
          this.globalForm.value_data.iptuGaragemParcelado = this.validForm.mascaraMoeda(
            this.globalForm.value_data.iptuGaragemParcelado
          );
          break;
